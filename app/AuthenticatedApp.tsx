      ...
      <div className="container mx-auto px-4 py-8">
            ...
            <div className="flex justify-between items-center mb-3">
              ...
              <div className="flex items-center space-x-2">
                ...
                <button
                  ...
                  className="btn-primary p-2 rounded-full shadow-elevation-1"
                ...
                <button
                  ...
                  className="text-secondary hover:text-primary-600 transition-advance p-2"
                  aria-label="Sign out"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <nav className="mb-8">
          <div className="border-b border-neutral-600/20">
            <div className="-mb-px flex space-x-4 md:space-x-8 overflow-x-auto">
              <button
                onClick={() => setActiveTab('snippets')}
                className={`py-3 px-2 md:px-1 border-b-2 font-medium text-sm whitespace-nowrap transition-advance ${
                  activeTab === 'snippets'
